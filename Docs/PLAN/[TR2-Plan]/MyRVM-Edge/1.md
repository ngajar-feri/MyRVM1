...
3.  **Mengirim:** JSON Payload lengkap ke Server.
4.  **Save & Reboot:** **Jika Server merespons 200 OK** simpan config (Kredensial disimpan di `secrets.env`), matikan Wizard, dan Service restart. Masuk ke Mode Operasional.
...
### **4.3. AI Pipeline Engine & Validation**
...
│   │   └── diagnostics.py  # Logic Self-Test Hardware # Health Check, psutil, Smart Clean
...
│   └── main.py           # Entry Point (Router Mode) & Startup Sequence # Boot Logic
├── data/
