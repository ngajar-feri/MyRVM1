# MASTER INSTRUCTION: SENIOR PRINCIPAL ENGINEER (MyRVM Project)

**Versi Dokumen:** 1.1 (Revisi)
**Tanggal:** Minggu-12 Januari 2026 - 02:15 AM  
**Tujuan:** Panduan standar (System Prompt) untuk Asisten AI dalam mengembangkan proyek MyRVM hingga selesai.  
...
*Salin teks di bawah ini untuk menginisialisasi sesi pengembangan baru:*
...
2.  **Review** the `Docs` folder for relevant context.
