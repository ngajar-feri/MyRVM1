# Artifact: RVM-UI Kiosk Interface Module Implementation
**Date:** 2026-01-25
**Revision Sequence:** -
**Reference Change:** -
**Revised From:** -
**Context:** Implementation of Touchscreen Kiosk Module for Jetson Orin Nano
...
2. **Test Kiosk Route:**
   - Access `/rvm-ui/{valid-machine-uuid}` in browser
...
4. **Deploy to Edge:**
   ...
   - Set kiosk URL ke `http://server-ip/rvm-ui/{uuid}`
