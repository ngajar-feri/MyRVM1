---
description: Refactor the selected code to improve its quality while maintaining the same functionality, providing the refactored code with explanations of the improvements made.
---
